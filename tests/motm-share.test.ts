...
test("openbare share- en niet-gevondenpagina laden stylesheetversie 5",()=>{for(const html of [renderPublicShare(match("open")),renderPublicNotFound()]){assert.match(html,/\/motm\.css\?v=5/);assert.doesNotMatch(html,/\/motm\.css\?v=4/)}});
